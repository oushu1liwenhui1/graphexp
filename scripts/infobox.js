...
var infobox = (function(){
               ...
               graphElem_bar.append("h2").text("实体信息")
               ...
               append_keysvalues(info_table,{"节点标签":""},"bold");
               append_keysvalues(info_table,data_to_display,"normal");
               data_to_display = data[1][0];
               append_keysvalues(info_table,{"节点属性":""},"bold");
               append_keysvalues(info_table,data_to_display,"normal");
               var data_to_display = data[2][0];
               append_keysvalues(info_table,{"边标签":""},"bold");
               append_keysvalues(info_table,data_to_display,"normal");
               data_to_display = data[3][0];
               append_keysvalues(info_table,{"边属性":""},"bold");
               append_keysvalues(info_table,data_to_display,"normal");
               }
